...
def test_release_docx_uses_versioned_source_title_and_release_metadata(tmp_path: Path) -> None:
    ...
    expected = datetime(2026, 7, 27, tzinfo=timezone.utc)
    assert properties.title == "DeepSeek Agent V3 使用说明（0.12.2）"
    ...
    assert properties.keywords == "DeepSeek Agent V3, v0.12.2, 2026-07-27"
    ...
    assert "2026-07-27T00:00:00Z" in core_xml
